...
importers:
  ...
  .:
    dependencies:
      ...
      streamdown:
        specifier: ^1.4.0
        version: 1.4.0(@types/react@19.2.2)(react@19.2.0)
      tailwind-merge:
        specifier: ^3.3.1
        version: 3.3.1
      tailwindcss-animate:
...
packages:
  ...
  vite-plugin-manus-runtime@0.0.56:
    resolution: {integrity: sha512-BkRMoFzUtT5enXBl+PO0h81KH+4uK4WpLGOp1tvljafb6fp9UX0b1klfxQz9QZFEdB8IPQTEkNzfqv09fHrkMw==}
...
snapshots:
  ...
  jspdf-autotable@5.0.2(jspdf@3.0.4):
    dependencies:
      jspdf: 3.0.4
  ...
  lucide-react@0.453.0(react@19.2.0):
    dependencies:
      react: 19.2.0
